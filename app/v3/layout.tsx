...
const NAV: NavItem[] = [
  { href: "/v3/zgloszenia", label: "Zgłoszenia", icon: InboxIcon },
  { href: "/v3/podmioty", label: "Firmy", icon: BuildingIcon },
  { href: "/v3/projekty", label: "Projekty", icon: FolderIcon },
  { href: "/v3/uslugi", label: "Usługi", icon: PackageIcon },
  { href: "/v3/polecenia", label: "Polecenia", icon: ArrowRightLeftIcon },
  { href: "/v3/zespol", label: "Zespół", icon: UserCircleIcon },
];
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-screen w-[232px] flex-col bg-muted/40 dark:bg-card/60 border-r border-border/50">
      ...
      <div className="px-3 pb-3 space-y-1">
        <button
          onClick={() => router.push("/v3/ustawienia")}
...
const ROUTE_LABELS: Record<string, string> = {
  "/v3/zgloszenia": "Zgłoszenia",
  "/v3/podmioty": "Firmy",
  "/v3/projekty": "Projekty",
  "/v3/uslugi": "Usługi",
  "/v3/polecenia": "Polecenia",
  "/v3/zespol": "Zespół",
};
