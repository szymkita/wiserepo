      ...
      <div className="space-y-1.5">
        <div className="relative">
          <input
            ...
            readOnly={readOnly}
            className={cn(
              "peer block w-full appearance-none px-3 pb-2.5 pt-4 text-sm text-foreground outline-none transition-all duration-200",
              v.container,
              s.border,
              !disabled && !readOnly && s.focusBorder,
              !disabled && !readOnly && v.focus,
              !disabled && !readOnly && v.hover,
              !disabled && !readOnly && state === "default" && s.focusRing,
              !disabled && !readOnly && state !== "default" && s.focusRing,
              disabled && v.disabled,
              readOnly && v.readOnly,
          ...
          <label
            ...
            className={cn(
              ...
              isOutlined
                ...
                : "bg-transparent",
              // Resting state (when placeholder shown)
...
export type { FloatingFieldState as FloatingInputState } from "./floating-field.types";
